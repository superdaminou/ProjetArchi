...
int gen_aluA()
{
    return ((((icode) == (I_ENTER)) & ((ifun) == 0)) ? -4 : (((icode) == (I_ENTER)) & ((ifun) == 1)) ? (vala) : (((icode) == (I_ALU)) & ((ra) == (REG_NONE))) ? (valc) : ((icode) == (I_ALU)) ? (vala) : (((icode) == (I_RRMOVL)) & ((ra) == (REG_NONE))) ? (valc) : ((icode) == (I_RRMOVL)) ? (vala) : ((icode) == (I_RMMOVL)||(icode) == (I_MRMOVL)) ? (valc) : ((icode) == (I_CALL)||(icode) == (I_PUSHL)) ? -4 : ((icode) == (I_RET)||(icode) == (I_POPL)) ? 4 : 0);
}
